...
const queen = '<i class="fa-solid fa-chess-queen" style="color:#000"></i>';

let n, speed, tempSpeed, q, Board = 0;

// Creating an array for all the possible arrangements of the N-Queen
...
playButton.onclick = async function visualise() {
    ...
    // Removing all the previous execution context
